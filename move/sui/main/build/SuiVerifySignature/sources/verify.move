...
module sui_verify_signature::verify{
    ...
    public fun test_verify_addr() {
        ...
        let price = x"0000000000000000000000000000000000000000000000000500c0d709874000"; // TODO: do the padding in-code
        let timestamp = x"00000000000000000000000000000000000000000000000000000000641226cc"; // TODO: do the padding in-code
